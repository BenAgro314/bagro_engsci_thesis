...
from thesis.visualization import plotting
from thesis.simulation.sim import Camera, World, render_camera_points

#%% load dataset

dataset = scipy.io.loadmat('april-trial2.mat')
...
rho_i_pj_i = dataset["rho_i_pj_i"] # a 3x20 matrix where the jth column is the poisition of feature j
...
ys_with_invalid = dataset["y_k_j"][:, ind, :].T[:, :, None]
