...
def metrics_fcn(example: StereoLocalizationExample, num_tries = 100):
    ...
    if example_id not in global_sdp_solved_example_ids:
        ...
        global_sdp_solved_example_ids[example_id] = global_sdp_soln
    else:
        global_sdp_soln = global_sdp_solved_example_ids[example_id]
...
def main(dataset_name: str):
    ...
    plot_percent_succ_vs_noise(metrics, os.path.join(exp_dir, "solver_comparison"))
